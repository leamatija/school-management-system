...
import com.internship.spring.project.schoolmanagementsystem.domain.exception.StorageFileNotFoundException;
...
public class FileSystemStorageService implements StorageService {
	...
	@Autowired
	public FileSystemStorageService(@Value("${fs.root-dir}") String location) {
